  ...
  const sendDataToApi = async (values) => {
    ...
    try {
      ...
      const response = await axios.post(
        `${baseUrl}/api/Admin/CreateCarAlbum?id=${id}`,
        formData,
        {
          headers: {
      ...
      <form onSubmit={formik.handleSubmit}>
        <div className="d-flex justify-content-around pt-3">
          <div className="">
            ...
            />
            {frontError && (
              <div className="alert alert-danger">{frontError}</div>
            )}
          ...
          <div className="">
            <label htmlFor="backImageUpload">
              {backImage ? (
                <div className="div-img" style={{ overflow: "hidden" }}>
                  <img src={backImage} alt="back" className="uploaded-image" />
                </div>
              ) : (
                <div className="div-img">
                  {" "}
        ...
        <div className="d-flex justify-content-around">
          <div className="">
            ...
            />
            {rightError && (
              <div className="alert alert-danger">{rightError}</div>
            )}
          ...
          <div className="">
            <label htmlFor="leftImageUpload">
              {leftImage ? (
                <div className="div-img" style={{ overflow: "hidden" }}>
                  <img src={leftImage} alt="left" className="uploaded-image" />
                </div>
              ) : (
                <div className="div-img">
                  {" "}
        ...
        >
          <div className="text-center div-user">
            <img src={user} alt="driver" className="w-25" />
          </div>

...
export default function Login() {
  ...
  function sendDataToApi(values) {
    setbtnloading(true);
    axios
      .post(`${baseUrl}/api/Admin/Login`, values)
      .then((response) => {
    ...
    <div className="container-fluid">
      <div className="row">
        <div className="col-md-6 col-img vh-100">
          <div>
            <img src={logologin} alt="" className="" />
          </div>
          <div className="d-flex justify-content-center align-content-center mt-5">
            {" "}
            <img src={imglogin} alt="" className="w-75" />
          </div>
        </div>
            ...
            <form onSubmit={login.handleSubmit}>
              <div>
                <input
                  ...
                  name="username"
                  type="text"
                  className="form-control my-4 input-phone"
              ...
              <div className="position-relative">
                <input
                  ...
                  className="form-control my-4 input-password"
                  placeholder="Password"
                />
                <i onClick={onShowHide}>
                  {show ? (
                    <i className="fa-regular fa-eye icon-password"></i>
                  ) : (
                    <i className="fa-regular fa-eye-slash icon-password"></i>
                  )}
                </i>
              </div>

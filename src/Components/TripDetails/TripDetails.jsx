...
export default function TripDetails() {
  ...
  const sendDataToApi = (values) => {
    setbtnloading(true);
    axios
      .post(`${baseUrl}/api/Admin/CreateTrip`, values, {
        headers: {
      ...
      .then((response) => {
        ...
        const { latitude, longitude } = response.data.data.pickup;
        navigate(`/addtrip/assigndriver/${response.data.data._id}`, {
  ...
  const validationSchema = Yup.object().shape({
    ...
    specialNeeds: Yup.string()
      .notRequired()
      .max(255, "Special needs must be less than 255 characters"),
      ...
      <form onSubmit={trip.handleSubmit}>
        <div className="d-flex input-container">
          <div className="w-50 input-width">
            ...
            <input
              type="text"
              className="form-control mt-2  mb-4  py-2 w-75 mx-3"
              name="firstName"
              value={trip.values.firstName}
              onChange={trip.handleChange}
              placeholder="First Name"
              onBlur={trip.handleBlur}
            />
            {trip.errors.firstName && trip.touched.firstName ? (
              <div className="alert alert-danger w-75 mx-3">
                {trip.errors.firstName}
              </div>
            ) : (
              ""
            )}
            ...
            <input
              ...
              className="form-control mt-2  mb-4  py-2 w-75 mx-3"
              name="lastName"
              value={trip.values.lastName}
              onChange={trip.handleChange}
              placeholder="Last Name"
              onBlur={trip.handleBlur}
            />
            {trip.errors.lastName && trip.touched.lastName ? (
              <div className="alert alert-danger w-75 mx-3">
                {trip.errors.lastName}
              </div>
            ) : (
              ""
            )}
            ...
            <input
              ...
              className="form-control   mt-2  mb-4  py-2 w-75 mx-3"
              name="phone"
              value={trip.values.phone}
              onChange={trip.handleChange}
              placeholder="Phone"
              onBlur={trip.handleBlur}
            />
            {trip.errors.phone && trip.touched.phone ? (
              <div className="alert alert-danger w-75 mx-3">
                {trip.errors.phone}
              </div>
            ) : (
            ...
            <input
              ...
              name="birthDate"
              value={trip.values.birthDate}
              onChange={trip.handleChange}
              onBlur={trip.handleBlur}
            />
            {trip.errors.birthDate && trip.touched.birthDate ? (
              <div className="alert alert-danger w-75 mx-3">
                {trip.errors.birthDate}
              </div>
            ) : (
              ""
            )}
            ...
            <input
              ...
              value={trip.values.specialNeeds}
              onChange={trip.handleChange}
              onBlur={trip.handleBlur}
            />
            {trip.errors.specialNeeds && trip.touched.specialNeeds ? (
              <div className="alert alert-danger w-75 mx-3">
                {trip.errors.specialNeeds}
              </div>
            ) : (
              ""
            )}
            ...
            <input
              ...
              className="form-control   mt-2  mb-4  py-2 w-75 mx-3"
              name="number"
              value={trip.values.number}
              onChange={trip.handleChange}
              placeholder="Number"
              onBlur={trip.handleBlur}
            />
            {trip.errors.number && trip.touched.number ? (
              <div className="alert alert-danger w-75 mx-3">
                {trip.errors.number}
              </div>
            ) : (
          ...
          <div className="w-50 input-width">
            ...
            <input
              ...
              className="form-control   mt-2  mb-4  py-2 w-75 mx-3"
              name="cost"
              value={trip.values.cost}
              onChange={trip.handleChange}
              placeholder="Cost"
              onBlur={trip.handleBlur}
            />
            {trip.errors.cost && trip.touched.cost ? (
              <div className="alert alert-danger w-75 mx-3">
                {trip.errors.cost}
              </div>
            ) : (
            ...
            <input
              ...
              className="form-control  mt-2  mb-4  py-2 w-75 mx-3"
              name="date"
              value={trip.values.date}
              onChange={trip.handleChange}
              onBlur={trip.handleBlur}
            />
            {trip.errors.date && trip.touched.date ? (
              <div className="alert alert-danger w-75 mx-3">
                {trip.errors.date}
              </div>
            ) : (
            ...
            <input
              ...
              className="form-control   mt-2  mb-4  py-2 w-75 mx-3"
              name="type"
              value={trip.values.type}
              onChange={trip.handleChange}
              placeholder="Type"
              onBlur={trip.handleBlur}
            />
            {trip.errors.type && trip.touched.type ? (
              <div className="alert alert-danger w-75 mx-3">
                {trip.errors.type}
              </div>
            ) : (
            ...
            <input
              ...
              className="form-control   mt-2  mb-4  py-2 w-75 mx-3"
              name="time"
              value={trip.values.time}
              onChange={trip.handleChange}
              placeholder="Time"
              onBlur={trip.handleBlur}
            />
            {trip.errors.time && trip.touched.time ? (
              <div className="alert alert-danger w-75 mx-3">
                {trip.errors.time}
              </div>
            ) : (
        ...
        <div className="text-end">
          <button
            type="submit"
            className="btn-bg btn px-5 py-2 my-3 mx-3 fw-bold"
            disabled={!trip.isValid}
          >

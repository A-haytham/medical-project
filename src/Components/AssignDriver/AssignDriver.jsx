...
export default function AssignDriver() {
  ...
  async function getDriver() {
    ...
    try {
      const data = await axios.get(
        `${baseUrl}/api/Admin/NearestDrivers?latitude=${latitude}&longitude=${longitude}`,
        {
          headers: {
  ...
  const sendDataToApi = () => {
    setbtnloading(true);
    axios
      .put(`${baseUrl}/api/Admin/UpdateTrip?id=${id}`, obj, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      })
  ...
  return (
    <div className="container-fluid">
      {loading ? (
        ...
        driver.map((item) => (
          <div
            className="row my-3 py-3 brdr justify-content-around text-center"
            key={item.driver._id}
          >
            ...
            <div className="col-md-2 d-flex justify-content-center">
              <div className="images">
                <img src={item.driver.user.profileImage} alt="" />
              </div>
            </div>
            ...
            <div className="col-md-2 d-flex align-items-center justify-content-center">
              {item.driver.visible === false ? (
                <span>
                  <i className="fa-solid fa-circle off pe-2"></i>Offline
                </span>
              ) : (
                <span>
                  <span className="fa-solid fa-circle on pe-2"></span>Online
                </span>
              )}
            </div>
            <div className="col-md-2 d-flex align-items-center justify-content-center">

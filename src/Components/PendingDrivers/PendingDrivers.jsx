...
export default function PendingDrivers() {
  ...
  function getPageCount() {
    axios
      .get(`${baseUrl}/api/Admin/Drivers/PendingPagesCount`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      })
  ...
  function getPage(currentPage) {
    setloading(true);
    axios
      .get(`${baseUrl}/api/Admin/PendingDrivers/${currentPage}`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      })
      ...
      <>
        ...
        <div className="container-fluid bg-light">
          <div className="d-flex justify-content-between py-4 widdth m-auto input-child ">
            <input
              type="search"
              className="form-control w-25 input-see"
              placeholder="search"
            />
            <Link
              to="/adddriver/personaldata"
              className="btn btn-bg mt-3 mt-md-0"
            >
              {" "}
              + Add Driver
            </Link>
              ...
              pendingdrivers.map((item) => (
                <div className="row my-3 py-3 brdr   " key={item._id}>
                  ...
                  <div
                    ...
                    className="namee  col-md-2 col-xl-1 name-color d-flex align-items-center justify-content-center  text-md-end text-xl-center "
                  >
                  ...
                  <div
                    ...
                    style={{ width: "370px", textAlign: "left" }}
                  >
                  ...
                  <div className="col-md-2 d-flex align-items-center justify-content-center ">
                    {item.location.address.split(" ").slice(0, 3).join(" ")}
                  </div>
                  <div className="col-md-2 d-flex align-items-center justify-content-center">
                    {item.user.phone}
                  </div>
                  <div className="col-md-2 d-flex align-items-center justify-content-center ">
                    {item.visible === false ? (
                      <span>
                        <i className="fa-solid fa-circle off pe-2"></i>Offline
                      </span>
                    ) : (
                      <span>
                        <span className="fa-solid fa-circle on pe-2"></span>
                        Online
                      </span>
                    )}
                  </div>
                  <div className="col-md-2 d-flex align-items-center justify-content-center">
                    {item.onTrip === false ? (
                      ...
                      <span>
                        <i className="fa-solid fa-car-side pe-2"></i>On Trip
                      </span>
                    )}
                  </div>
                  <div className="col-md-1 col-xl-2 d-flex align-items-center justify-content-center">
                    ...
                    <Link
                      ...
                      to={{
                        pathname: `/updatedriver/updatepersonaldata/${item._id}`,
                      }}
